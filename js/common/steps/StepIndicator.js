    ...
    renderStep = (position) => {
      ...
      switch (this.getStepStatus(position)) {
        case STEP_STATUS.CURRENT: {
          ...
          indicatorLabelStyle = { fontSize: this.customStyles.currentStepIndicatorLabelFontSize, color: this.customStyles.stepIndicatorLabelCurrentColor, opacity:0 };
        ...
        case STEP_STATUS.FINISHED:{
          ...
          indicatorLabelStyle = { fontSize: this.customStyles.stepIndicatorLabelFontSize, color: this.customStyles.stepIndicatorLabelFinishedColor, opacity:0 };
          break;
        }
        ...
        case STEP_STATUS.UNFINISHED:{
          ...
          indicatorLabelStyle = {overflow: 'hidden', fontSize: this.customStyles.stepIndicatorLabelFontSize, color: this.customStyles.stepIndicatorLabelUnFinishedColor, opacity:0 };
          break;
        }
        default:
      }
